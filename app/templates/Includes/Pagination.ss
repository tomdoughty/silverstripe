      ...
      <% if $Results.NotFirstPage %>
        <li class="nhsuk-pagination-item--previous">
          <a class="nhsuk-pagination__link nhsuk-pagination__link--prev" href="$Results.PrevLink">
            ...
            <span class="nhsuk-pagination__page">$OneLess($Results.CurrentPage) of $Results.TotalPages</span>
      ...
      <% if $Results.NotLastPage %>
        <li class="nhsuk-pagination-item--next">
          <a class="nhsuk-pagination__link nhsuk-pagination__link--next" href="$Results.NextLink">
            ...
            <span class="nhsuk-u-visually-hidden">:</span>
            <span class="nhsuk-pagination__page">$OneMore($Results.CurrentPage) of $Results.TotalPages</span>
